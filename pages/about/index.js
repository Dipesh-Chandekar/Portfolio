...
// Data Skills: Data Cleaning, Data Visualization, Statistical Analysis, Predictive Modeling
// Other Skills: Problem-Solving, Project Management, Chat.GPT and Other AI tools.
  ...
  },
  {
    title: "achievements",
    info: [ 
//       Certified Data Analyst by Vertocity.
// Certified in Python Programming by LearnTube.
// Certified in Microsoft Power BI for Data Analysis by LinkedIn Learning.
...
const About = () => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      <Circles />
      <motion.div
        className="xl:flex absolute bottom-0 -left-[21vh] xl:h-[450px] max-[1400px]:-left-[28vh]"
        ...
        <div className="flex-1 flex-col justify-center">
          <div className="flex-1 flex flex-col justify-center">
            ...
            <motion.p variants={fadeIn("right", 0.4)}
              ...
              I am a Data Science and Analytics professional passionate about harnessing the power of data to 
              drive informed decision-making. With a strong foundation in statistical analysis, machine learning, 
              and data visualization, I leverage tools like Python, Power BI, SQL, and Excel to transform complex 
              datasets into actionable insights. My analytical and problem-solving skills enable me to uncover trends 
              and optimize strategies across various industries.
              <br />
              I thrive in collaborative and innovative environments, where I can work alongside teams to explore 
              data-driven solutions that make a tangible impact.<br /> Committed to continuous learning and growth, 
              I am dedicated to staying at the forefront of emerging technologies and methodologies in the field of data science.
